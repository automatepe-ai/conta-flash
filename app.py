            ...
            if excel_bytes:
                ...
                if 'RUC' in df.columns and 'Razon_Social' in df.columns:
                    ...
                    <div style="background:#1e3a5f;
                                border-radius:10px;padding:0.75rem;margin:0.5rem 0 1rem 0;color:white;">
                        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:0.5rem;">
                            <span style="font-size:1rem;font-weight:700;color:#d4880f;">📊 Resumen por RUC</span>
                            <span style="font-size:0.8rem;opacity:0.8;">{len(empresas_stats)} empresa{'s' if len(empresas_stats) > 1 else ''}</span>
                        </div>
                    """, unsafe_allow_html=True)
                    ...
                    for i, row in empresas_stats.iterrows():
                        ...
                        st.markdown(f"""
                        <div style="background:#f5f0e8;border-radius:6px;padding:0.7rem;margin-bottom:0.5rem;">
                            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:0.35rem;">
                                <span style="font-size:0.9rem;font-weight:600;color:#2d2a26;">{razon}</span>
                                <span style="font-size:0.75rem;color:#6b6560;">RUC: {ruc}</span>
                            </div>
                            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0.35rem;">
                                <div style="text-align:center;padding:0.3rem;background:#faf7f2;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#27ae60;">{_fmt_soles(igv_ventas)}</div>
                                    <div style="font-size:0.7rem;color:#6b6560;">VENTAS</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#faf7f2;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#e74c3c;">{_fmt_soles(igv_compras)}</div>
                                    <div style="font-size:0.7rem;color:#6b6560;">COMPRAS</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#faf7f2;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#d4880f;">{_fmt_soles(renta)}</div>
                                    <div style="font-size:0.7rem;color:#6b6560;">RENTA</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#faf7f2;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:{neto_color};">{neto_signo}{_fmt_soles(neto_igv)}</div>
                                    <div style="font-size:0.7rem;color:#6b6560;">NETO</div>
                                </div>
                            </div>
                            <div style="font-size:0.7rem;color:#6b6560;margin-top:0.25rem;text-align:right;">
                    ...
                    st.markdown(f"""
                        <div style="border-top:1px solid #d4880f;padding-top:0.6rem;margin-top:0.4rem;">
                            <div style="font-size:0.8rem;font-weight:600;color:#27ae60;margin-bottom:0.4rem;">✅ TOTALES CONSOLIDADOS</div>
                            <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:0.35rem;">
                                <div style="text-align:center;padding:0.3rem;background:#eafaf1;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#27ae60;">{_fmt_soles(totales['C101'])}</div>
                                    <div style="font-size:0.7rem;color:#2d2a26;">VENTAS</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#fdeaea;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#e74c3c;">{_fmt_soles(totales['C108'])}</div>
                                    <div style="font-size:0.7rem;color:#2d2a26;">COMPRAS</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#fef9e7;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:#d4880f;">{_fmt_soles(totales['C312'])}</div>
                                    <div style="font-size:0.7rem;color:#2d2a26;">RENTA</div>
                                </div>
                                <div style="text-align:center;padding:0.3rem;background:#eafaf1;border-radius:4px;">
                                    <div style="font-size:0.85rem;font-weight:700;color:{neto_total_color};">{neto_signo}{_fmt_soles(neto_total)}</div>
                                    <div style="font-size:0.7rem;color:#2d2a26;">A PAGAR</div>
                                </div>
                            </div>
                        </div>
                    </div>
